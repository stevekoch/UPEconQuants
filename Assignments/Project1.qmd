...
In terms of the data that will be used for the analysis, we will capture all (adult-focused)^[NIDS has a separate child survey that would be interesting to examine, but will not be the focus of this research, given the time and other resources available.] health and healthcare seeking information (including illness, behaviours, medical aid coverage and/or medical expenses), as well as standard socio-demographic controls, such as: income/expenditure, education, age, population group, gender. Yes, there is likely to be more information that is useful. For our purposes, however, this is enough. 
